...
test('cashier API derives store from authenticated session and an open drawer gates writes', async () => {
  ...
  assert.match(index, /requireOpenDrawer\(env\.DB, auth\.cashier\)/);
